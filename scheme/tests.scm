...
'(cons Taylor Chanun)
; expect (cons taylor chanun)

(cdr '(Taylor Chanun))
; expect (chanun)

; Problem 8 Tests
(begin (+ 10 110) (+ 150 110))
; expect 260

(begin (display '(my number is)) (+ 0 11))
; expect (my number is)11
...
; Problem 10 Tests
(define function (lambda (x) (+ 1 x)))
; expect function
(define func (lambda (x) (/ x 0)))
; expect func
func(2)
;expect Error
...
; Problem 12 Tests
; Just calling lambdas, already covered in previous test cases

; Problem 13 Tests
(define single #t)
(define cuffed #f)
(or single (1/0) cuffed)
; expect #t
...
; Problem 16 Tests
(define f (mu () (/ a b)))
(define g (lambda () (define a 10) (define b 0) (f)))
(g)
; expect Error
